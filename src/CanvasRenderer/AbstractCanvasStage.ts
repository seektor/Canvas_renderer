...
export abstract class AbstractCanvasStage extends AbstractCanvasBaseLayer implements ILayerHost {
    ...
    protected addLayer(layer: ILayer, layerPositionExtractor: ILayerPosAndDimExtractor) {
        this.subLayers.push(layer);
        this.subLayersRelativePosAndDimExtractorsMap.set(layer, layerPositionExtractor);
    }

    protected addComponent(component: AbstractCanvasComponent, layerPositionExtractor: ILayerPosAndDimExtractor) {

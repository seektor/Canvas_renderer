...
import { TVerticalScrollbarStyles } from './TVerticalScrollbarStyles';

export class CVerticalScrollbarPainter extends CanvasBasePainter {

    private styles: TVerticalScrollbarStyles;
    ...
    public drawArrowButton(ctx: CanvasRenderingContext2D, rect: TRect, direction: Direction.Up | Direction.Down, active?: boolean): void {
        const horizontalPadding: number = this.scrollbarBorderWidth;

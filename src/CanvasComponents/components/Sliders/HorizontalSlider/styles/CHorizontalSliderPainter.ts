...
import { THorizontalSliderStyles } from './THorizontalSliderStyles';

export class CHorizontalSliderPainter extends CanvasBasePainter {

    private styles: THorizontalSliderStyles;
    ...
    public drawBackground(ctx: CanvasRenderingContext2D, rect: TRect): void {
        ...
        this.fillRect(ctx, rect, { fillStyle: Colors.ORANGE })
    }

...
import { TFillTextStyles, TStrokeArcStyles } from '../../../../CanvasRenderer/utils/painter/structures/CanvasPainterTypes';
...
export class CGaugePainter extends CanvasBasePainter {
    ...
    constructor(gaugeAngleRange: TRange, gaugeAngleColorRanges: TColorRange[]) {
        super();
    ...
    public drawGauge(ctx: CanvasRenderingContext2D, rect: TRect, minText: string, maxText: string): void {
        ...
        const textStyles: TFillTextStyles = {
